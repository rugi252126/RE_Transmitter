...
// Macros definition for digital I/O pins
...
// Enumerations for digital port states
#if 0
...
// Enumerations for digital input pins
enum digitalIn_et
{
...
// Enumerations for digital output pins
enum digitalOut_et
{
     HAL_DO_LED_IND_E      // 0
    ,HAL_DO_BUZZER_E       // 1
...
protected:
    //uint8_t  adc_8bit_u8[HAL_ADC_MAX_INDEX_E];
    //uint16_t adc_10bit_u16[HAL_ADC_MAX_INDEX_E];
    //uint16_t adc_raw_16[HAL_ADC_MAX_INDEX_E];
    struct adc_data_st
    {
        uint8_t  adc_8bit_u8;
        uint16_t adc_10bit_u16;
        uint16_t adc_raw_16;
    };
